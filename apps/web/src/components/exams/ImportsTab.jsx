          ...
          <div style={{ 
            ...
            <div style={{ textAlign: 'center', maxWidth: '720px', margin: '0 auto' }}>
              <span style={{ 
                ...
                <HiSparkles style={{ fontSize: '15px', color: '#6366f1' }} /> CÔNG NGHỆ BÓC TÁCH TỰ ĐỘNG BẰNG AI VISION
              </span>
              <h2 style={{ fontSize: '26px', fontWeight: '800', color: '#0f172a', margin: '16px 0 10px 0', letterSpacing: '-0.02em' }}>
                Bóc Tách &amp; Nhập Đề Thi Tự Động Với AI
              </h2>
              <p style={{ fontSize: '14px', color: '#64748b', margin: 0, lineHeight: '1.6' }}>
                Hệ thống tự động phân tích cấu trúc đề thi, cắt ảnh sắc nét từng câu hỏi và nhận diện chính xác đáp án, công thức Toán - Lý - Hóa chỉ trong vài giây.
              </p>
            </div>
            ...
            >
              ...
              {selectedFile ? (
                ...
                <span style={{ fontSize: '13px', color: '#64748b' }}>Hỗ trợ tệp định dạng .PDF, .DOCX hoặc .DOC (Kéo thả hoặc nhấp vào khung để chọn tệp)</span>
              )}
            </label>
                        ...
                        <tr key={session.id} style={{ borderBottom: '1px solid #f1f5f9' }}>
                          ...
                          <td style={{ padding: '16px 20px', fontWeight: '700', color: '#0f172a' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                              <span>📄</span>
                              <span>{fixFileNameEncoding(session.fileName)}</span>
                            </div>
                          </td>
